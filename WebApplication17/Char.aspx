...
<body class="Home">
    ...
    <div class="content">
        <Center>
            ...
            <form runat="server" name="text">
                <label>Please enter your string</label>
                <br />
                <textarea id="Char" rows="10" cols="50" name="input" style="border-block-color: #414241; border-block: groove; background-color: #393E46; color: #F2E7D5 "></textarea>
                <br />
