<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="WebApplication17.signup" %>
...
<body class="Home">
    ...
    <div class="content">
        <center>
            ...
            <form method="post" runat="server" action="signup.aspx">
                ...
                <select id="region" name="region" style="width:500px"><br />
